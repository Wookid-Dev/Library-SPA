...
const KPIModal = ({ isOpen, onClose, data }: KPIModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="relative bg-white rounded-lg shadow-lg max-w-3xl w-full p-6">
        ...
        <div className="mb-6">
          <div className="bg-gray-200 rounded-lg shadow h-20 flex justify-center items-center mx-auto w-2/4">
            <p className="text-gray-500">KPI Chart/Preview</p>
          </div>
        </div>

        <h3 className="text-lg font-bold mb-4">Applicable Affiliates</h3>
        ...
        {data.businessQuestions && data.businessQuestions.length > 0 && (
          <div className="mb-6">
            <h3 className="text-lg font-bold mb-4">Business Questions</h3>
