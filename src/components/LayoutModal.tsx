...
const LayoutModal = ({ isOpen, onClose, data }: LayoutModalProps) => {
      ...
      <div className="relative bg-white rounded-lg shadow-lg max-w-3xl w-full p-6">
        ...
        <div className="mb-6">
          <div className="bg-gray-200 rounded-lg shadow h-24 flex justify-center items-center mx-auto w-2/4">
            <p className="text-gray-500">Layout Preview</p>
          </div>
        </div>

        <h3 className="text-lg font-bold mb-4">KPIs Used</h3>
        <div className="grid grid-cols-2 gap-4 mb-6">
          {data.kpisUsed.map((kpi, index) => (
            <div
              key={index}
